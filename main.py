...
class ProductPanel:
    ...
    def __init__(self, parent_frame, index):
        ...
        self.entry_name = tk.Entry(self.frame, width=22, bg="#e0e5ec")
...
class CompareApp:
    def __init__(self, root):
        ...
        # --- Scrollable Area Setup (Boilerplate) ---
        self.canvas_frame = tk.Frame(root)
        self.canvas_frame.pack(fill="x", expand=False, padx=10, pady=5)
        self.canvas = tk.Canvas(self.canvas_frame, height=450)
        ...
        # --- RESULTS AREA ---
        self.result_text = tk.Text(root, height=14, font=("Courier", 10), bg="#1e1e1e", fg="#00ff00")
        self.result_text.pack(padx=20, pady=10, fill="both")
    ...
    def run_analysis(self):
        ...
        for item in data_points:
            # FIXED LINE BELOW: switched order to :<6.2f
